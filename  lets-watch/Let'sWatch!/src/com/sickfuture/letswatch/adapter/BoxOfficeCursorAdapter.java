...
public class BoxOfficeCursorAdapter extends CursorAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.mCriticsConsensusTextView = (TextView) view.findViewById(R.id.box_office_critics_consensus_text_view);
	...
	public void bindView(View view, Context context, Cursor cursor) {
		...
		if (!TextUtils.isEmpty(cursor.getString(cursor.getColumnIndex(Contract.BoxOfficeColumns.POSTERS)))) {
			ImageLoader.getInstance().bind(this,
							holder.mPosterImageView,cursor.getString(cursor.getColumnIndex(Contract.BoxOfficeColumns.POSTERS)));
		}
