...
public abstract class CustomExecutorAsyncTask<Params, Progress, Result> {
            ...
            protected void done() {
                ...
                try {
                    ...
                    message = sHandler.obtainMessage(MESSAGE_POST_CANCEL,
                            new AsyncTaskResult<Result>(CustomExecutorAsyncTask.this, (Result[]) null));
                ...
                message = sHandler.obtainMessage(MESSAGE_POST_RESULT,
                        new AsyncTaskResult<Result>(CustomExecutorAsyncTask.this, result));
                message.sendToTarget();
            }
        };
    }
    ...
    public final CustomExecutorAsyncTask<Params, Progress, Result> execute(Params... params) {
    ...
    //Overloaded {@link #execute(Params)} method which lets you use your Executor
    //which will execute task
	public final CustomExecutorAsyncTask<Params, Progress, Result> execute(Executor executor, Params... params) {
        if (mStatus != Status.PENDING) {
            switch (mStatus) {
                case RUNNING:
                    throw new IllegalStateException("Cannot execute task:"
